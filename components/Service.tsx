      ...
      <div className={styles.slantBg_inner}>
        ...
        <div className={styles.headline_box_center}>
          <h2 className={styles.headline}>
            遠隔接客サービス
            <span>RURAは店頭スタッフと変わらない接客サービスの提供を目指しています。</span>
          </h2>
        </div>
          ...
          <div className={`serviceWrap ${styles.contentFlex}`}>
            ...
            >
              <div className={styles.boxRound_inner}>
                ...
                <div className={styles.txtBoxA}>
                  <h3 className={styles.headlineMed}>いつものスタッフが画面から</h3>
                  <p>店頭に立っていたスタッフが画面越しに多拠点接客できるようになります。</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className={styles.boxRound_inner}>
                ...
                <div className={styles.txtBoxA}>
                  <h3 className={styles.headlineMed}>顔出し、アバター、キャラクター</h3>
                  <p>
